    ...
    return (
        <article className="max-w-4xl mx-auto py-12 space-y-12">
            <div className="space-y-6">
                ...
                <div className="h-1 w-24 bg-accent-red" />
            </div>

            <div
                className="prose prose-invert prose-slate max-w-none text-slate-200 leading-relaxed text-xl font-medium tracking-tight mt-16"
