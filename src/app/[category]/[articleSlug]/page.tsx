                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between pt-8 border-t border-white/5 gap-6">
                            <div className="flex items-center space-x-4">
                                ...
                                <div className="space-y-0.5">
                                    ...
                                    <div className="text-[9px] text-white/70 uppercase font-black tracking-widest">{article.author.role}</div>
                                </div>
                            </div>
            ...
            <div className="max-w-screen-2xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16 mt-16">
                ...
                <aside className="lg:col-span-4 space-y-12">
                    <div className="sticky top-32 space-y-12">
                        {/* Promoted Advisory - Priority Pos 1 */}
                        <AdContainer />

                        {/* Related Research - Priority Pos 2 */}
