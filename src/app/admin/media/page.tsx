    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-[#1E293B] dark:border-[#1E293B]">
                ...
                <Button className="h-11 rounded-xl font-black uppercase tracking-widest text-[11px] px-6 shadow-xl bg-[#0F172A] text-white dark:bg-white dark:text-[#0F172A] hover:bg-black dark:hover:bg-white/90">
                    <Plus className="h-4 w-4 mr-2" /> Upload Assets
                </Button>
            </div>

            <div className="min-h-[400px] flex flex-col items-center justify-center border-2 border-dashed border-[#1E293B] rounded-[2.5rem] bg-[#020617]/20">
                <div className="p-6 rounded-full bg-[#020617]/50 border border-[#1E293B] mb-4">
                    <ImageIcon className="h-12 w-12 text-[#64748B]" />
                </div>
                <h3 className="text-lg font-black uppercase text-[#F1F5F9] italic">Asset Manager Offline</h3>
                <p className="text-sm text-[#64748B] font-black uppercase tracking-widest mt-2">Structural Initialization Required for Media Storage.</p>
            </div>
        </div>
    );
}
