    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-[#1E293B] dark:border-[#1E293B]">
                <div>
                    <h1 className="text-3xl font-black tracking-tight text-slate-900 dark:text-[#94A3B8] uppercase italic pb-1">Strategic <span className="text-[#64748B] dark:text-[#F1F5F9] not-italic">Contributors</span></h1>
                    <p className="text-[#64748B] dark:text-[#94A3B8] text-xs font-black uppercase tracking-widest">Manage external analysts and guest researchers.</p>
                </div>
            ...
            <div className="min-h-[400px] flex flex-col items-center justify-center border-2 border-dashed border-[#1E293B] rounded-[2.5rem] bg-card/50">
                ...
                <h3 className="text-lg font-black uppercase text-foreground italic">Personnel Register Empty</h3>
                <p className="text-sm text-muted-foreground font-black uppercase tracking-widest mt-2">No guest analysts are currently authorized.</p>
            </div>
        </div>
    );
}
