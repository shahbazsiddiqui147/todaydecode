        ...
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-[#1E293B] dark:border-[#1E293B]">
                <div className="space-y-1">
                    <h1 className="text-3xl font-black uppercase tracking-tighter text-[#0F172A] dark:text-[#22D3EE] italic pb-1">Site <span className="text-[#64748B] dark:text-[#F1F5F9] not-italic">Architecture</span></h1>
                                        ...
                                        <TableRow key={item.id} className="group border-b border-[#1E293B]/50 hover:bg-slate-900/40 transition-colors">
                                            <TableCell className="py-5 pl-8">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <span className="text-sm font-black uppercase tracking-tight text-foreground">{item.label}</span>
                                                </div>
                                            </TableCell>
                                            <TableCell>
