                ...
                <Table>
                    <TableHeader className="bg-[#020617]/50">
                        <TableRow className="border-b border-[#1E293B] hover:bg-transparent">
                            <TableHead className="py-5 pl-8 text-[#64748B] dark:text-[#94A3B8] font-black uppercase text-[10px] tracking-widest">Page Title</TableHead>
                            <TableHead className="text-[#64748B] dark:text-[#94A3B8] font-black uppercase text-[10px] tracking-widest">URL Path</TableHead>
                            <TableHead className="text-[#64748B] dark:text-[#94A3B8] font-black uppercase text-[10px] tracking-widest">Last Modified</TableHead>
                            <TableHead className="text-right pr-8 text-[#64748B] dark:text-[#94A3B8] font-black uppercase text-[10px] tracking-widest">Actions</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                        {loading ? (
                            <TableRow>
                                <TableCell colSpan={4} className="h-64 text-center">
                                    <div className="flex flex-col items-center space-y-4">
                                        ...
                                        <span className="text-[10px] font-black uppercase tracking-widest text-[#64748B]">Loading pages...</span>
                                    </div>
                                </TableCell>
                            </TableRow>
                        ) : pages.length === 0 ? (
                    ...
                    <div className="relative bg-[#020617] w-full max-w-5xl rounded-[2.5rem] border border-[#1E293B] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                        <div className="p-10 border-b border-[#1E293B] flex justify-between items-center bg-[#020617]/50">
                            <div className="space-y-1">
                                ...
                                <p className="text-[10px] font-black uppercase tracking-widest text-[#64748B]">Static page content management</p>
                            </div>
                        ...
                        <form onSubmit={handleSubmit} className="p-10 space-y-8 max-h-[75vh] overflow-y-auto bg-[#020617]">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-3">
                                    <label className="text-[10px] font-medium uppercase tracking-widest text-[#1E293B] dark:text-[#94A3B8]">Page Title</label>
                                    <Input
                                        required
                                ...
                                <div className="space-y-3">
                                    <label className="text-[10px] font-medium uppercase tracking-widest text-[#1E293B] dark:text-[#94A3B8]">URL Slug</label>
                                    <Input
                                        required
                            ...
                            <div className="pt-10 flex justify-end space-x-4">
                                <Button type="button" variant="ghost" className="h-12 px-8 rounded-xl font-black uppercase tracking-widest text-[10px] text-muted-foreground hover:text-foreground" onClick={() => setIsModalOpen(false)}>Cancel</Button>
                                <Button type="submit" className="h-12 px-10 rounded-xl bg-[#0F172A] text-white dark:bg-white dark:text-[#0F172A] font-black uppercase tracking-widest text-[10px] shadow-xl hover:bg-black dark:hover:bg-white/90">Save Page</Button>
                            </div>
                        </form>
                    </div>
                </div>
